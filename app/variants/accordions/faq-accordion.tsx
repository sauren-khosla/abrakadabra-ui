  ...
  return (
    <div className="w-full max-w-2xl mx-auto py-4 px-1">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        {categories.map((category) => (
          <button
            ...
            className={cn(
              "px-4 h-6 text-xs rounded-full border",
              selectedCategory === category ? "bg-black text-white" : "bg-white text-gray-700"
            )}
          >
            {category}
          </button>
      ...
      {filteredFAQs.length === 0 && (
        <p className="text-center text-gray-500 mt-4">No FAQs match your search.</p>
      )}
    </div>
  )
}
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Navigate to your account settings and update your billing details.",
  },
  {
    id: "faq3",
    category: "Technical",
